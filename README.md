    ...
    <div class="brand">
        ...
        <div>
            ...
            <div class="brand-subtitle">
                U.S.–Japan Bilateral Legal Framework
            </div>
        </div>
    </div>
...
<div class="panel">
    ...
    <div class="panel-body">
        ...
        <label class="drop-zone" id="dropZone">
            ...
            <small>
                Drag and drop a document here or select a file
            </small>
        ...
        <textarea
            id="documentText"
            placeholder="Paste the text of the proposed legislation, regulation, agreement, or other legal instrument here..."
        ></textarea>
...
/* Preliminary legal classification engine */
...
function generateAnalysis(text) {
    ...
    if (containsAny(tradeTerms)) {
        ...
        potentialFindings.push({
            ...
            treaty:
                "Relevant U.S.–Japan economic and trade instruments",
    ...
    if (containsAny(defenseTerms)) {
        ...
        potentialFindings.push({
            ...
            treaty:
                "Relevant U.S.–Japan defense and security agreements",
    ...
    if (containsAny(technologyTerms)) {
        ...
        potentialFindings.push({
            ...
            treaty:
                "Relevant U.S.–Japan technology and economic instruments",
    ...
    if (containsAny(taxTerms)) {
        ...
        potentialFindings.push({
            ...
            treaty:
                "U.S.–Japan income tax treaty framework",
    ...
    if (score >= 70) {
        ...
        description =
            "Multiple areas require substantive treaty review";
        ...
        description =
            "Potential treaty implications identified";
        ...
        description =
            "Limited treaty-relevant language detected";
    ...
    if (potentialFindings.length === 0) {
        ...
        findings.innerHTML = `
            ...
            <div class="empty-state">
                ...
                No potential treaty conflicts identified
    ...
    /* Correct finding rendering */

    findings.innerHTML =

        potentialFindings.map(item => `
            ...
            <div class="finding">
                ...
                <div class="finding-header">
                    ...
                    <div class="severity ${escapeHTML(item.severity)}">
                ...
                <div class="finding-body">
                    ...
                    <div class="finding-grid">
                        ...
                        <div>
                            ...
                            <div class="field-label">
                                Relevant Treaty Corpus
                            </div>

                            <div class="field-value">
                                ${escapeHTML(item.treaty)}
                            </div>
